...
const eventSchema = new mongoose.Schema(
  {
    eventCode: { type: String, unique: true, index: true },
    customer: {
    ...
    eventRequest: { type: mongoose.Schema.Types.ObjectId, ref: "EventRequest" },
...
eventSchema.pre("save", async function () {
  ...
  this.eventCode = `EVT${String(count + 1).padStart(5, "0")}`;
});
